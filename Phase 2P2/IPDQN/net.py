...
class Net:
    ...
    def _make(self):
        self._make_ph()
        self.delta_s, self.o1, self.o2,self.o3 = self._build_net_pt(self.s_ph, 'pre-cnn', 'pre-dense')
        self.s_Q,  self.a1, self.a2,self.a3 = self._build_net(self.s_ph, 'online-cnn', 'online-dense')
        self.target_Q, self.b1, self.b2,self.b3 = self._build_net(self.ns_ph, 'target-cnn', 'target-dense')
