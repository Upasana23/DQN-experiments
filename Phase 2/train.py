...
filePath = '/users/upattnai/Phase2/'
resultPath = '/users/upattnai/Phase2/resultsTennis_Pong/'
weightsPath = '/users/upattnai/Phase1/BaseDQNResults/Tennis/tennis_results/10000000_weights.pk1'
envName = 'Tennis_Pong'
...
def main():
  ...
  logger.log('Breakout from Freeway Practice. epsilon 1.0 to 0.1 in 5e5. 10000000_weights.pkl') 
