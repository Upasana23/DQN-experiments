...
class Net:
    ...
    def _build_train(self):
        ...
        self.init_online_op2 = tf.group(*ops_init2)  #operation for updating the RL training network during iterative training    
        ...
        self.update_practice = tf.group(*ops_prac) #operation for updating the Practice network during iterative training
    ...
    #training function for Practice during iterative training    
